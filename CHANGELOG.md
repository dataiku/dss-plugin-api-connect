...
## [Version 1.5.0](https://github.com/dataiku/dss-plugin-api-connect/releases/tag/v1.5.0) - Feature - 2026-08

- Add Cobuild support to the API Connect recipe
...
- Fixing possible double slash issues with `next page` pagination mode in relative URL mode
- Fixing dataset issue with empty returns from post
...
- Allow query strings to have same key, different values
